...
//     const formattedNumber = number.toString().split('.').join('')
...
const PlayerTable = ({ players }) => {
  ...
  //   key: index,
  //   game: `${moment(stats.game.date).utc().format('MMM DD')}`,
  ...
  return <Table columns={columns} dataSource={dataSource} size="middle" onRow={handleOnRow} />
}
